...
_generated 2026-05-30T15:38:26.031874+00:00_

## Run summary

- source: `jsonl:///private/tmp/otel-fi/bundles-with-logs.jsonl`
- traces observed: 454
- new events: 454
- idempotent skips: 0
- cursor: `∅` → `4737191`
- quality band distribution: high=1, low=6, medium=447
- rule matches: downstream_error=1
- abstentions: no_rule_matched=451, weak_evidence=2

## Recurring patterns (rule-grounded)

| rule | recurrence | first seen | last seen | quality | services | operations |
|---|---:|---|---|---|---|---|
| `downstream_error` | 1 | 2026-05-30 15:35 | 2026-05-30 15:35 | high | cart, checkout, currency, frontend, frontend-proxy, load-generator (+3) | POST, POST /api/checkout, POST /get-quote, POST /getquote (+4) |
...
| `weak_evidence` | 2 | 2026-05-30 15:34 | 2026-05-30 15:35 | cart, checkout, currency, frontend, frontend-proxy, load-generator (+3) | POST, POST /api/checkout, POST /get-quote, POST /getquote (+4) |
